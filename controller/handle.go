...
import (
	...
	"github.com/offer365/oblog/logic"
...
func IndexHandle(c *gin.Context) {
	...
	if err != nil {
		...
		c.HTML(http.StatusInternalServerError, "html/500.html", nil)
		return
	}
...
func CategoryList(c *gin.Context) {
	...
	articleRecordList, err := logic.GetArticleRecordListByCategoryId(int(categoryId), 0, 15)
	if err != nil {
		fmt.Printf("get article failed, err:%v\n", err)
		c.HTML(http.StatusInternalServerError, "html/500.html", nil)
		return
...
func NewArticle(c *gin.Context) {
	...
	c.HTML(http.StatusOK, "html/post_article.html", categoryList)
}
...
func LeaveNew(c *gin.Context) {
	...
	c.HTML(http.StatusOK, "html/gbook.html", leaveList)
}

func AboutMe(c *gin.Context) {
	c.HTML(http.StatusOK, "html/about.html", gin.H{
		"title": "Posts",
	})
}
...
func ArticleDetail(c *gin.Context) {
	...
	c.HTML(http.StatusOK, "html/detail.html", m)
}
